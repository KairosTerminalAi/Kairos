    ...
    def __init__(
        ...
        if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"by KAIROS-AGENT.  Choose a model with at least "
        ...
        try:
            ...
            if aux_context and aux_context < MINIMUM_CONTEXT_LENGTH:
                raise ValueError(
                    ...
                    f"minimum {MINIMUM_CONTEXT_LENGTH:,} required by Kairos "
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    if (
                        ...
                        from hermes_constants import display_hermes_home as _dhh_fn
                        _dhh = _dhh_fn()
                        print(f"{self.log_prefix}     • Check ANTHROPIC_TOKEN in {_dhh}/.env for Kairos-managed OAuth/setup tokens")
