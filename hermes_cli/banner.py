...
def format_banner_version_label() -> str:
    ...
    base = f"KAIROS-AGENT v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else KAIROS_AGENT_LOGO
        console.print(_logo)
        console.print()
