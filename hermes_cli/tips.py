...
TIPS = [
    ...
    "Ctrl+Z suspends Kairos to the background — run fg in your shell to resume.",
    ...
    "kairos mcp serve runs Kairos itself as an MCP server for other agents.",
    ...
    "kairos backup creates a zip backup of your entire Kairos home directory.",
    ...
    "kairos gateway install sets up Kairos as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Kairos tools programmatically — results stay out of context.",
    ...
    "When exiting, Kairos prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Kairos runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Kairos via a local macOS server.",
    ...
    "Kairos loads project context from .kairos.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "kairos acp runs Kairos as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Kairos your own.",
    ...
    "Before a gateway session reset, Kairos auto-flushes important facts to memory in the background.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Kairos auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Kairos config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Kairos is working.',
    ...
    'kairos dashboard --tui embeds the full Kairos TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Kairos block commands when the tirith scanner itself errors out.',
