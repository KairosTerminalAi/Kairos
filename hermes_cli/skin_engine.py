...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Kairos — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Kairos Agent",
            "welcome": "Welcome to Kairos Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Kairos ",
            "prompt_symbol": "❯",
